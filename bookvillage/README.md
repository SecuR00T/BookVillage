# BOOKVILLAGE Security Learning Bookshop
...
- 관리자: `admin@bookvillage.mock` / `password`
- 학생: `user@bookvillage.mock` / `password`
...
- REST Client 샘플: `docs/bookvillage-labs.http`
