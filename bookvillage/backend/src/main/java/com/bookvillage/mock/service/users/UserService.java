package com.yes24.mock.service.users;
...
import com.yes24.mock.repository.admin.AccessLogRepository;
...
/**
 * ???쳛??? IDOR - userId ?롪틵?嶺??β돦裕뉐퐲??熬곣뫁逾?
 * getById, update, getOrdersByUserId???????븐슙???userId???잙갭梨???????
 */
@Service
