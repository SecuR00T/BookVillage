package com.yes24.mock.service.admin;

import com.yes24.mock.dto.admin.AdminDashboardDto;
import com.yes24.mock.dto.books.BookDto;
import com.yes24.mock.dto.orders.OrderDto;
import com.yes24.mock.dto.users.UserDto;
import com.yes24.mock.entity.admin.*;
import com.yes24.mock.entity.board.*;
import com.yes24.mock.entity.books.*;
import com.yes24.mock.entity.orders.*;
import com.yes24.mock.entity.reviews.*;
import com.yes24.mock.entity.support.*;
import com.yes24.mock.entity.users.*;

import com.yes24.mock.repository.admin.*;
import com.yes24.mock.repository.board.*;
import com.yes24.mock.repository.books.*;
import com.yes24.mock.repository.orders.*;
import com.yes24.mock.repository.reviews.*;
import com.yes24.mock.repository.support.*;
import com.yes24.mock.repository.users.*;
import com.yes24.mock.service.support.CustomerServiceService;
...
public class AdminService {
    ...
    public BookDto createBook(Book book) {
        if (book.getPrice() == null || book.getPrice().doubleValue() <= 0) {
            throw new IllegalArgumentException("媛寃⑹씠 ?묒닔?ъ빞 ?⑸땲??");
        }
        if (book.getStock() == null || book.getStock() < 0) {
            throw new IllegalArgumentException("?ш퀬媛 0蹂대떎 ?묎굅??媛숈븘???⑸땲??");
        }
