...
INSERT IGNORE INTO users (email, username, password, name, phone, address, role) VALUES
('admin@bookvillage.mock', 'admin', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Admin', '010-0000-0000', 'Seoul', 'ADMIN'),
('user@bookvillage.mock', 'user', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Test User', '010-1234-5678', 'Seoul', 'USER');
