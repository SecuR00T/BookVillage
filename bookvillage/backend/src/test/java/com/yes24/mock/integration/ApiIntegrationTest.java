package com.yes24.mock.integration;
...
import com.yes24.mock.repository.CouponRepository;
...
class ApiIntegrationTest {
    ...
    void setUp() {
        ...
        User admin = new User();
        admin.setEmail("admin@yes24.mock");
        ...
        userAuth = basic("user@yes24.mock", "password");
        adminAuth = basic("admin@yes24.mock", "password");
    }
    ...
    void registerSuccess() throws Exception {
        mockMvc.perform(post("/api/auth/register")
                        ...
                        .content(objectMapper.writeValueAsString(Map.of(
                                "email", "new@yes24.mock",
                                "password", "newpassword",
                                "name", "New User"
                        ))))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.email").value("new@yes24.mock"));
    }
    ...
    void loginSuccess() throws Exception {
        mockMvc.perform(post("/api/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(Map.of(
                                "email", "user@yes24.mock",
                                "password", "password"
                        ))))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.email").value("user@yes24.mock"));
    }
