    ...
    <PageLayout hideIntro>
      <section className="mx-auto max-w-6xl space-y-5">
        ...
        <div className="grid gap-5 xl:grid-cols-[1.05fr_1.35fr]">
          ...
          <div className="space-y-5">
            <section ref={recentRef} className="rounded-2xl border border-border bg-card p-5">
            ...
            <section ref={wishlistRef} className="rounded-2xl border border-border bg-card p-5">
            ...
            <section ref={orderRef} className="rounded-2xl border border-border bg-card p-5">
