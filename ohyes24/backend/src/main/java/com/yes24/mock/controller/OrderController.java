...
import com.yes24.mock.dto.CartRequest;
import com.yes24.mock.dto.GuestOrderLookupDto;
import com.yes24.mock.dto.OrderDto;
import com.yes24.mock.security.UserPrincipal;
import com.yes24.mock.service.LearningFeatureService;
import com.yes24.mock.service.OrderService;
...
public class OrderController {
    ...
    public ResponseEntity<OrderDto> getOrderDetail(
        ...
        return ResponseEntity.ok(orderService.getOrderDetailByUserId(principal.getUserId(), orderId));
    }
