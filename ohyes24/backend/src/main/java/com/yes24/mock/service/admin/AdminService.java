...
import com.yes24.mock.dto.AdminDashboardDto;
import com.yes24.mock.dto.BookDto;
import com.yes24.mock.dto.OrderDto;
import com.yes24.mock.dto.UserDto;
import com.yes24.mock.entity.*;
import com.yes24.mock.repository.*;
...
public class AdminService {
    ...
    public BookDto createBook(Book book) {
        if (book.getPrice() == null || book.getPrice().doubleValue() <= 0) {
            throw new IllegalArgumentException("가격이 양수여야 합니다.");
        }
        if (book.getStock() == null || book.getStock() < 0) {
            throw new IllegalArgumentException("재고가 0보다 작거나 같아야 합니다.");
        }
