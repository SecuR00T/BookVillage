      ...
      <main className="container mx-auto px-4 py-6 space-y-9">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {features.map(({ icon: Icon, label, desc }) => (
            <div key={label} className="flex items-center justify-center gap-3 bg-card rounded-xl p-4 border border-border">
        ...
        {!loading && !error && (
          <>
            ...
            <section className="relative overflow-hidden rounded-[22px] bg-gradient-to-r from-[hsl(24,38%,27%)] via-[hsl(28,34%,32%)] to-[hsl(32,31%,38%)] px-6 py-7 sm:px-9 sm:py-8">
